<template>
  <article
    class="relative flex items-start space-x-6 p-6 max-w-[370px] xl:max-w-[360px] 2xl:max-w-[400px] w-full hover:shadow-lg transition bg-gray-800 rounded-md group min-h-[160px]"
  >
    <div
      class="-bottom-16 opacity-0 group-hover:opacity-100 group-hover:bottom-0 right-0 flex absolute items-end justify-center w-full px-5 bg-gradient-to-t from-gray-900 to-transparent h-full rounded-b-md transition"
    >
